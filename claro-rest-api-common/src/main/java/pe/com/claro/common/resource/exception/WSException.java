...
public class WSException extends BaseException {
	...
	public WSException(String code, String message, String nomService) {
	      super(code, message, nomService);
	}
	...
	public WSException(String code, String message, String nomService, Exception exception) {
		super(code, message, nomService, exception);
	}
	
	public WSException(String code, String message, String messageDeveloper, String nomService ) {
	      super(code, message, messageDeveloper, nomService);
	}
	...
	public WSException(String code, String message, String messageDeveloper, Exception exception, int status, String nomService) {
		super(code, message, messageDeveloper, exception, status, nomService);
	}
